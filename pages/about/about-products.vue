<template>
  <div v-if="productsInformation">
    ...
    <div id="about-products" class="about__products">
      <div class="container">
        <h3
          class="about__products-title page__title"
          data-aos="fade-right"
          data-aos-duration="700"
        >
          Сумки
        ...
        <div
          v-for="(item, index) in productsInformation"
          :key="index"
          class="about__content"
        >
          <h4
            class="about__content-title page__title"
            data-aos="fade-right"
            data-aos-duration="700"
          >
            {{ item.title }}
          ...
          <div class="about__inner">
            <div
              ...
              data-aos-duration="700"
            >
              <div class="about__item-text" v-html="item.text"></div>
              <a
                class="about__item-btn page__border-btn"
