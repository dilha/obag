    ...
    <template v-if="OrderModal">
      <div class="modal__container">
        <div class="modal__one-click-order">
          <h6 class="modal__one-click-order-title">Заказать в 1 клик!</h6>
          <p
            v-if="error"
          ...
          <form
            class="modal__one-click-order-form"
            @submit.prevent="handleOrder"
          >
            <input
              v-model="user.name"
              class="modal__one-click-order-input modal__one-click-order-name"
              type="text"
              placeholder="Имя"
              required
            />
            <input
              ...
              @keydown="phonemusk"
              id="phone-mask"
              class="modal__one-click-order-input modal__one-click-order-phone"
              type="text"
