    ...
    <div class="content">
      <div class="reviews__header flex-row">
        ...
        <div class="reviews__slider__actions flex-row">
          <app-button slot="button-prev" icon="arrow-left" tag="button" to="#" width="4" height="6.85"
            class="slider-actions__prev-button button-cirle" :class="{
              ' button-cirle--active': activeSlideIndex !== 1,
            }" @click="prevSlide"></app-button>
          <app-button slot="button-next" to="#" icon="arrow-right" tag="button" width="4" height="6.85"
            class="slider-actions__next-button button-cirle" :class="{
              ' button-cirle--active': activeSlideIndex !== pageCount,
            }" @click="nextSlide"></app-button>
        </div>
      </div>
    </div>
    <!-- <div class="reviews__full-wrapper"> -->
    <div class="reviews__slider-container">
      <div v-show="selectedReview" ref="reviewsExpand" class="reviews__expand flex-row">
        <div v-if="selectedReview" class="content flex-row">
          <div class="reviews__slide-image-wrapper flex-row">
            <img :src="getImage(selectedReview.image)" alt="" class="reviews__slide-image" />
          </div>
      ...
      <!-- </div> -->
      <div class="content">
        <swiper ref="reviewsSlider" class="swiper reviews__slider" :options="swiperOption">
          <swiper-slide v-for="item in slides" :key="item.id" class="reviews__slide flex-row">
            <div class="reviews__slide-image-wrapper flex-row">
              <img :src="getImage(item.image)" alt="" class="reviews__slide-image" />
            </div>
            <div class="reviews__slide-description flex-col">
