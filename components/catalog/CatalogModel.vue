<template>
  <div
    v-if="selectedCategory && selectedCategory.subcategories.length"
  ...
  >
    ...
    >
      <swiper-slide
        ...
        :class="[
          'catalog__model-item',
          { 'is-active': selectedSubCategory === item.id },
        ]"
        :data-id="item.id"
      ...
      >
        ...
        <img
          v-else
          class="catalog__model-item-cover-image"
          src="@/assets/images/icons/obag.png"
          :alt="item.title"
        />
      </swiper-slide>
    </swiper>
