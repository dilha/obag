  ...
  <div v-if="item" class="product__card">
    <div class="product__card-image">
      <div class="product__card-top">
        ...
        <button
class="product__card-bookmark" :class="{ active: item.isFavorite || isFavorite }"
    ...
    <div class="product__card-bottom">
      <button
class="page__basket-btn product__card-basket" :class="{ active: isAdded }" :disabled="isAdded"
        @click="add(item)">
        В корзину
        <svg
aria-hidden="true" focusable="false" data-prefix="fas" data-icon="shopping-cart" class="cart" role="img"
...
fill="currentColor"
        ...
        <svg
aria-hidden="true" focusable="false" data-prefix="fas" data-icon="box" class="box" role="img"
...
fill="currentColor"
      ...
      <nuxt-link class="product__card-link" :to="{ name: 'products-id', params: { id: item.id } }">Подробнее</nuxt-link>
    </div>
